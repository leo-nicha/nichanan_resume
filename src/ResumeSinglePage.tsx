            ...
            <aside className="md:col-span-1">
              ...
              <section className="mb-6">
                ...
                <div className="text-sm text-gray-700 space-y-1">
                  <div>54/81 Phumvet 3 Rd., Pakkred, Nonthaburi, Thailand</div>
                  <div>Tel. (+66) 92-771-8029</div>
                  <div>Email: <a className="text-blue-600 underline" href="mailto:nicha_bz@hotmail.co.th">nicha_bz@hotmail.co.th</a></div>
                  <div>LINE ID: bzcrescent</div>
                  <div>Telegram: @leo_9229</div>
                </div>
              </section>
              ...
              <section className="mb-6">
                <h3 className="text-md font-semibold">Technical & Tools</h3>
                <div className="mt-2 text-gray-700 text-sm space-y-2">
                  ...
                  <div><strong>Dev & Web:</strong> HTML, CSS, Tailwind CSS, JavaScript, TypeScript, React</div>
